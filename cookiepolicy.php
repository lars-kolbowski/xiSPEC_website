...
<html>
	...
	<body>
			...
			<div class="container">
				...
				<p>XiSpec ("us", "we", or "our") uses cookies on the http://spectrumviewer.org website (the "Service"). By using the Service, you consent to the use of cookies.</p>

				<p>Our Cookies Policy explains what cookies are, how we use cookies, how third-parties we may partner with may use cookies on the Service, your choices regarding cookies and further information about cookies. Cookies Policy created by <a href="https://termsfeed.com" rel="nofollow">TermsFeed</a> for XiSpec.</p>
				...
				<li>
				    <p>For the Safari web browser, please visit this page from Apple: <a href="https://support.apple.com/kb/Ph31411?locale=en_US">https://support.apple.com/kb/Ph31411?locale=en_US</a></p>
				</li>
				<li>
