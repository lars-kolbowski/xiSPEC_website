...
var PeptideView = Backbone.View.extend({
				...
				pepLetterG[0][0].onclick = function() {
					if(self.changeCL){
						...
						if (this.childNodes[1].getAttribute("pep") == 0)		//pep1
							self.linkPos[0].linkSite = parseInt(this.childNodes[0].getAttribute("pos"));
						else
							self.linkPos[1].linkSite = parseInt(this.childNodes[0].getAttribute("pos"));
	...
	resize: function(){
		...
		console.log("fragkeywidth before: "+fragKeyWidth+25);
		var i = 1;
