<?php
	...
	$query =  "SELECT MIN(id) as id, count(id) as alt_count, mzid, pep1, pep2, linkpos1, linkpos2, charge, isDecoy, scores, protein1, protein2, passThreshold, file, scanID FROM identifications WHERE rank = 1 GROUP BY mzid ORDER BY id;";
